...
export class ApiGatewayStack extends Construct {
    ...
    addResource(serviceName: string, handler: IFunction) {
        ...
        const productResource = apgw.***REMOVED***.addResource('product');
        ...
        const categoryResource = apgw.***REMOVED***.addResource('category');
        ...
        const dealsResource = apgw.***REMOVED***.addResource('deals');
